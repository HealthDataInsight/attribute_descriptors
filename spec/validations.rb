...
describe 'attribute validations' do
  ...
  # class MyModel < AttributeDescriptors::ModelGenerators
  #   use_metadata_at METADATA_PATH
  #   #@@metadata = AttributeDescriptors.load_file(METADATA_PATH)
  #   generate_attributes_from_metadata
  #   generate_validations_from_metadata
  # end

  # class MyModel
  #   AttributeDescriptors::load_file METADATA_PATH
  #   AttributeDescriptors::generate_attributes
  #   AttributeDescriptors::generate_attributes
  # end
